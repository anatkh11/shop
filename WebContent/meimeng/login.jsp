...
%>
<%-- <c:if test="${empty SessionScope.users.user }">response.sendREdirect("index.jsp")</c:if> --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<section class="wrap user_form">
 ...
 <div class="rt_form">
  ...
  <ul>
   ...
   <li class="user_icon">
    <input type="text" class="textbox" name="username" placeholder="账号"/>
   </li>
   <li class="user_pwd">
    <input type="password" class="textbox" name="password" placeholder="密码"/>
   </li>
   <li class="link_li">
